...
public class BoardImp implements BoardRepository {
    ...
    public void insert(Board b) {
        tp.update("insert into board(title,category, writer, content, user_role, user_seq, add_date, up_date) value(?,?,?,?,?,?,?,?)",
                b.getTitle(), b.getCategory(), b.getWriter(), b.getContent(), b.getUser_role(), b.getUser_seq(), b.getAdd_date(), b.getUp_date());
    }
    ...
    public void update(Board b) {
        tp.update("update board set title=?, content=?, up_date=? where writer = ?",
                b.getTitle(), b.getContent(), b.getUp_date(), b.getWriter());
